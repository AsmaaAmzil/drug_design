...
"""
    ...
    def entity_filter(self, query: str, entity_and_relationship: dict):
        if entity_and_relationship is None:
            entity_and_relationship = {"entities": [], "relationships": []}
...
"""
        ...
        entity_set = set([entity[0] if isinstance(entity[0], str) else str(entity[0]) for entity in filtered_entities if isinstance(entity, (list, tuple)) and len(entity) > 0])
